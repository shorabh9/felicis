...
export default function FelicisHomepage() {
  ...
  // Animation for the ticker text
  useEffect(() => {
    if (!showTicker) return;
    
    // Initial setup - start position off-screen to the right
      ...
      {showTicker && (
        <div className="bg-blue-600 text-white py-2 relative overflow-hidden">
          <div className="flex">
            ...
            >
              Felicis Ventures launches First Cheque@felicis
            </div>
            {/* Duplicate text to create seamless looping effect */}
            <div 
              className="whitespace-nowrap font-medium"
