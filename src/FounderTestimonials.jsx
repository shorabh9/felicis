...
export default function TestimonialSlider() {
  ...
  const testimonials = [
    ...
    {
      id: 2,
      text: "Anytime we have an ask, the team at Felicis is incredibly efficient. They bring so much energy to the table, and that's exactly what you want from a partner. The team has worked with us to build the kind of culture and go-to-market strategy that will allow us to build a generational company.",
      author: "Paul Copplestone",
      title: "CEO AND CO-FOUNDER, SUPABASE"
    },
    {
      id: 3,
      text: "The Felicis team worked really hard to understand our business, and there's no commercial analog for what we do. The team was really quick to thoughtfully understand us, the company, the opportunity, and the industry. They flew across the country to have some barbecue and discuss defense problems, which said a lot to us.",
      author: "Nini Hamrick",
  ...
  return (
    <div className="max-w-screen-xl mx-auto">
      <div className="flex justify-between items-center mb-8 p-4">
        <h1 className="text-4xl font-bold text-gray-800">{showAll ? "Founders on Felicis" : "What founders say about us"}</h1>
        {!showAll && (
          <button 
